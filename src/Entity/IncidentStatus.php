...
use App\Repository\IncidentStatusRepository;
use Doctrine\ORM\Mapping as ORM;
use JsonSerializable;

#[ORM\Entity(repositoryClass: IncidentStatusRepository::class)]
#[ORM\Index(name: 'incidentstatus_hashid_idx', columns: ['hash_id'])]
#[ORM\HasLifecycleCallbacks]
class IncidentStatus implements JsonSerializable
{
  #[ORM\Id]
  #[ORM\GeneratedValue]
  ...
  #[ORM\OneToMany(targetEntity: Incident::class, mappedBy: 'status')]
  private $incidents;
